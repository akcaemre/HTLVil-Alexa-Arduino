...
void loop() {
  if (Serial.available() > 0) {
    ...
    // provisorische, aber keine dauerhafte loesung der Farbueberpruefung
      ...
      //TODO: den nutzer entscheiden lassen ob es mit "fade" oder ohne sein soll
...
void showBinary (int number) {
  // sry hobs vakackt, don't hate me mate
}
// this function shows a decimal number using the special leds
// void showDecimal(int n) {}
